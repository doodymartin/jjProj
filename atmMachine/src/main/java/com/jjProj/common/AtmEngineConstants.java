...
/**
 * ATM Machine/Engine constants class.
 */
public final class AtmEngineConstants {

    public static final String ATM_MACHINE_INPUT_ID_NAME = "input";
    public static final String ATM_MACHINE_OUTPUT_ID_NAME = "output";
    public static final String ATM_MACHINE_PROCESSED_ID_NAME = "processed";
